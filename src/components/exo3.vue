    ...
    sendresult() {
      ...
      if (this.choix === "carré") {
        if (this.cotecarre !== "") {
          this.pericarre = parseInt(this.cotecarre * 4);
          this.airecarre = parseInt(this.cotecarre) * parseInt(this.cotecarre);
          phraseResultat = `Vous avez saisi ${this.cotecarre} pour le coté du carré, le périmetre est de : ${this.pericarre} cm et l'aire est de ${this.airecarre} cm carré.`;
        } else {
        ...
        if (this.coterect1 !== "" && this.coterect2 !== "") {
          this.perirect = parseInt(this.coterect1 * 2 + this.coterect2 * 2);
          this.airerect = parseInt(this.coterect1) * parseInt(this.coterect2);
          phraseResultat = `Vous avez saisi ${this.coterect1} et ${this.coterect2} pour les cotés du rectangle, le périmetre est de : ${this.perirect} cm et l'aire est de ${this.airerect} cm carré.`;
        } else {
          phraseResultat = `Vous devez rentrer des valeurs avant de cliquer sur ok.`;
        }
      }
